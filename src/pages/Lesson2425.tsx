            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row items-center justify-between p-4 rounded-xl bg-slate-800/50 border border-slate-700/50">
                ...
                <button
                  ...
                  className={`px-5 py-2.5 rounded-lg text-sm font-bold transition-all shadow-md ${ammeterConn === "series"
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between p-4 rounded-xl bg-slate-800/50 border border-slate-700/50">
                ...
                <button
                  ...
                  className={`px-5 py-2.5 rounded-lg text-sm font-bold transition-all shadow-md ${voltmeterConn === "parallel"
